...
export default function About() {
    const MetaData = {
      title: "О компании",
      description: "Компания занимается изготовлением, производством, установкой и реализацией лестниц по выгодным ценам в городе Тюмени",
      keywords:
    ...
    const cards = [
        {
          ...
          },
          {
            ...
            description: 'Наш специалист приедет в удобное для вас время, чтобы точно оценить проект и учесть все ваши пожелания.',
            image: "/stairsA.jpg",
            link: 'tel:+79829895209',
            button_name: "получить консультацию",
          },
    ...
    const cards2 = [
        {
            ...
            description: 'Мы предлагаем лестницы по выгодным ценам, так как работаем без посредников. Наша продукция на 15-25% дешевле благодаря прямым продажам с завода.',
            image: "/stairsA.jpg",
            link: 'tel:+79829895209',
            button_name: "получить консультацию",
          },
          {
            title: 'Качество материалов - используем только проверенные и долговечные материалы',
            description: 'В производстве используем только высококачественные материалы, прошедшие строгий контроль, что гарантирует долговечность и надежность наших лестниц.',
            image: "/stairsA.jpg",
            link: 'tel:+79829895209',
            button_name: "получить консультацию",
          },
        ...
        <div className={`flex flex-col justify-between ${inter.className}`}>
          <div className="md:mt-[10px] mt-8">
            <div className="container">
              <h1 className="md:text-[40px] max-md:text-xl max-md:mb-2">Изготовление и установка лестниц в Тюмени</h1>
              <InfoCards
